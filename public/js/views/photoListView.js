var PhotoListView = function(){
  ...
  this.views = [];
  this.blankImage = {
    html: "<img class='changePhotoToOpaque' src='http://www.backpaco.com/wp-content/uploads/2015/04/yosemite-park.jpg'><div class='changeUrlBar'><input type='text' placeholder='To Add Photo: Paste URL, Hit Enter' class='changeUrl'></div>",
    photoId: null
  };
  this.pinId;
}
